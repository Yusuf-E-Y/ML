...
xtrain,xtest,ytrain,ytest =  train_test_split(x,y,test_size=0.3,random_state=44) # <-- x abd y test abd train values or varibles
Sc = StandardScaler()
...
plt.scatter(S.yaş,S.maaş,color="Blue")
plt.scatter(B.yaş,B.maaş,color="Red")
>>>>>>> d42b7f93637c19741bf8071050820cd07069fb09
plt.show()